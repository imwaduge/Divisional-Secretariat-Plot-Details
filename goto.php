                        ...
                        <div class="row align-items-center gt60">
                            ...
                            <div class="col-lg-6">
                                ...
                                <p class="margin-b-20 animated" data-anim-in="fadeInUp|0.2">
                                    I am a freelance designer with öve years of experience. I have completed more than 250 projects for international clients since 2018. To Expand my knowledge, I am pursuing a Bachelor of Information and Communication Technology (Honours) degree specializing in multimedia technology at the University of Sri Jayawardenepura.
                                </p>
                                <ul class="list-1 color-text-white font-01" data-ckav-smd="align-left margin-b-30">
                                    <li class="margin-b-5 animated" data-anim-in="fadeInUp|0.3"><i class="list-bullet margin-r-10 color-text-default fas fa-angle-right"></i> UI/UX Design</li>
                                    <li class="margin-b-5 animated" data-anim-in="fadeInUp|0.4"><i class="list-bullet margin-r-10 color-text-default fas fa-angle-right"></i> Logo & Brand Identity Design</li>
                                    <li class="margin-b-5 animated" data-anim-in="fadeInUp|0.5"><i class="list-bullet margin-r-10 color-text-default fas fa-angle-right"></i> Digital Marketing</li>
                                    <li class="margin-b-5 animated" data-anim-in="fadeInUp|0.5"><i class="list-bullet margin-r-10 color-text-default fas fa-angle-right"></i> Web Development</li>
                                    <li class="margin-b-5 animated" data-anim-in="fadeInUp|0.6"><i class="list-bullet margin-r-10 color-text-default fas fa-angle-right"></i> HTML | CSS | JavaScript | PHP | MySQL</li>
                                </ul>
                            </div>
                            </div>
                        </div>
        ...
        <div class="footer-area intro-element">
            <div class="container">
                <p class="c-text navigation">                
                    <a class="c-text  section-post" href="#about" onMouseOver="this.style.color='Red'" onMouseOut="this.style.color='white'" >Develop by @imwaduge</a> © <script>document.write(new Date().getFullYear());</script>
                </p>
            </div>
        </div>
        <!-- ************** END : FOOTER **************  -->
